...
public function insertDepartement($tableName,$conn){
...
public static function  selectAllDepartements($tableName,$conn){
    ...
    Public static function selectDepartementById($tableName,$conn,$id){
