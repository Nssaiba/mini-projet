...
<div class="menu">
<a id="A3" href="AdminPage.php"><b>Home</b></a>
<a class="nmarque"><b>SHOPY SHOP</b></a>
<a id="A1" href="Login.php"><b>Logout</b></a>

</div>
<div class="container my-5">
    <h2><b>List of Clients from database</b></h2>
    ...
    <table class="table">
       <thead>
        ...
        foreach($clients as $row) {
            ...
            $genre=Genre::selectGenreById('genres',$connection->conn,$row['idGenre']);
           echo " <tr>
            <td>$row[id]</td>
            <td>$row[firstname]</td>
            <td>$row[lastname]</td>
