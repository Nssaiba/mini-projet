...
public function insertGenre($tableName,$conn){
...
public static function  selectAllGenres($tableName,$conn){
    ...
    Public static function selectGenreById($tableName,$conn,$id){
